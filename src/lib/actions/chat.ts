...
- Present the actual pesos plainly, e.g. "May sobra kayong ₱X ngayong cutoff (₱Y pumasok, ₱Z nagastos, ₱W pang budget na di pa nagagastos, +₱V ipon ni Daddy)." — show the components (totalIncome, totalExpense, totalCategoryRemaining, daddyBalance), not just the final number, since this is exactly the kind of number worth double-checking.
